...
import 'package:modal/generated/l10n.dart';
...
class _LoginScreenState extends State<LoginScreen> with Helpers {
              ...
              child: Row(
                ...
                children: [
                  TextButton(
                    ...
                    child: Text( AppLocalizations.of(context)!.createnewaccount,style: TextStyle(color: Color(0xBF107AAA))),
                  ),
                  VerticalDivider(
                    thickness: 1,
                    indent: 8,
  ...
  bool checkData() {
    ...
    showSnackBar(context: context, content: AppLocalizations.of(context)!.enterrequireddata);
    return false;
  }
